...
struct bridge {
    ...
    struct ofproto *ofproto;    /* OpenFlow switch. */  // ->ofproto/ofproto-provider.h 指向一个of交换机，很重要。
 ...
 * Return true if an iface is successfully created, false otherwise. */
 /*根据配置 if_cfg 给br增加一个interface，如果指定的openflow端口号是负数，
 则表示自动分配
*/
static bool
